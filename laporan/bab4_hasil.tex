...
Tabel \ref{tab:results} menyajikan data kuantitatif rata-rata khusus pada pengujian skala korpus maksimal (1 GB) guna mengilustrasikan performa pada beban tinggi. Walaupun data untuk 1 MB, 10 MB, dan 100 MB tidak direpresentasikan secara terpisah dalam tabulasi ini untuk menyederhanakan penyajian data, pola kecepatan (SHA-256 > BLAKE2 > SHA-3) tetap konsisten pada seluruh ukuran data yang diuji.
